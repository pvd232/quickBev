...
/// :nodoc:
- (BOOL)textView:(UITextView * _Nonnull)_ shouldInteractWithURL:(NSURL * _Nonnull)_ inRange:(NSRange)_ interaction:(UITextItemInteraction)_ SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
@property (nonatomic, strong) UIFont * _Nonnull formFont;
/// :nodoc:
@property (nonatomic, strong) UIColor * _Nonnull formTextColor;
...
/// :nodoc:
- (CGFloat)tableView:(UITableView * _Nonnull)_ estimatedHeightForRowAtIndexPath:(NSIndexPath * _Nonnull)_ SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (void)viewDidLayoutSubviews;
/// :nodoc:
...
/// :nodoc:
- (void)handleCancelTapped:(id _Nullable)_;
- (void)paymentCardTextFieldDidChange:(STPPaymentCardTextField * _Nonnull)textField;
- (void)paymentCardTextFieldWillEndEditingForReturn:(STPPaymentCardTextField * _Nonnull)_;
- (void)paymentCardTextFieldDidBeginEditingCVC:(STPPaymentCardTextField * _Nonnull)textField;
- (void)paymentCardTextFieldDidEndEditingCVC:(STPPaymentCardTextField * _Nonnull)textField;
- (void)paymentCardTextFieldDidBeginEditing:(STPPaymentCardTextField * _Nonnull)_;
/// :nodoc:
...
/// :nodoc:
- (void)paymentAuthorizationController:(PKPaymentAuthorizationController * _Nonnull)_ didAuthorizePayment:(PKPayment * _Nonnull)payment handler:(void (^ _Nonnull)(PKPaymentAuthorizationResult * _Nonnull))completion;
/// :nodoc:
- (void)paymentAuthorizationController:(PKPaymentAuthorizationController * _Nonnull)_ didSelectShippingMethod:(PKShippingMethod * _Nonnull)shippingMethod handler:(void (^ _Nonnull)(PKPaymentRequestShippingMethodUpdate * _Nonnull))completion;
/// :nodoc:
- (void)paymentAuthorizationController:(PKPaymentAuthorizationController * _Nonnull)_ didSelectShippingContact:(PKContact * _Nonnull)contact handler:(void (^ _Nonnull)(PKPaymentRequestShippingContactUpdate * _Nonnull))completion;
/// :nodoc:
- (void)paymentAuthorizationControllerDidFinish:(PKPaymentAuthorizationController * _Nonnull)controller;
- (UIWindow * _Nullable)presentationWindowForPaymentAuthorizationController:(PKPaymentAuthorizationController * _Nonnull)_ SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// :nodoc:
- (BOOL)tableView:(UITableView * _Nonnull)_ shouldHighlightRowAtIndexPath:(NSIndexPath * _Nonnull)_ SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)_ bundle:(NSBundle * _Nullable)_ SWIFT_UNAVAILABLE;
@end
...
///
- (nonnull instancetype)initWithData:(NSData * _Nullable)data urlResponse:(NSURLResponse * _Nullable)_ error:(NSError * _Nullable)error;
...
/// :nodoc:
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)_ bundle:(NSBundle * _Nullable)_;
/// :nodoc:
...
/// already showing a view controller, or in the middle of requesting a payment.
- (void)requestPayment;
- (void)paymentOptionsViewController:(STPPaymentOptionsViewController * _Nonnull)_ didSelectPaymentOption:(id <STPPaymentOption> _Nonnull)paymentOption;
- (void)paymentOptionsViewControllerDidFinish:(STPPaymentOptionsViewController * _Nonnull)paymentOptionsViewController;
- (void)paymentOptionsViewControllerDidCancel:(STPPaymentOptionsViewController * _Nonnull)paymentOptionsViewController;
- (void)paymentOptionsViewController:(STPPaymentOptionsViewController * _Nonnull)_ didFailToLoadWithError:(NSError * _Nonnull)_;
- (void)shippingAddressViewControllerDidCancel:(STPShippingAddressViewController * _Nonnull)addressViewController;
- (void)shippingAddressViewController:(STPShippingAddressViewController * _Nonnull)_ didEnterAddress:(STPAddress * _Nonnull)address completion:(void (^ _Nonnull)(enum STPShippingStatus, NSError * _Nullable, NSArray<PKShippingMethod *> * _Nullable, PKShippingMethod * _Nullable))completion;
- (void)shippingAddressViewController:(STPShippingAddressViewController * _Nonnull)addressViewController didFinishWithAddress:(STPAddress * _Nonnull)address shippingMethod:(PKShippingMethod * _Nullable)method;
- (UIViewController * _Nonnull)authenticationPresentingViewController SWIFT_WARN_UNUSED_RESULT;
- (void)prepareAuthenticationContextForPresentation:(void (^ _Nonnull)(void))completion;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithGrabPay:(STPPaymentMethodGrabPayParams * _Nonnull)grabPay billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)_;
...
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithOxxo:(STPPaymentMethodOXXOParams * _Nonnull)oxxo billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)_;
...
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithAlipay:(STPPaymentMethodAlipayParams * _Nonnull)alipay billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)_;
...
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithPayPal:(STPPaymentMethodPayPalParams * _Nonnull)payPal billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)_;
...
/// An unknown type.
  STPPaymentMethodTypeUnknown = 19,
};
...
- (nonnull instancetype)initWithTheme:(STPTheme * _Nullable)_ OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Use one of the initializers declared in this interface instead.");
/// Use one of the initializers declared in this interface.
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)_ bundle:(NSBundle * _Nullable)_ OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Use one of the initializers declared in this interface instead.");
/// Use one of the initializers declared in this interface.
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)_ OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE_MSG("Use one of the initializers declared in this interface instead.");
/// :nodoc:
- (void)viewDidLayoutSubviews;
/// :nodoc:
- (void)viewDidAppear:(BOOL)animated;
- (void)addCardViewControllerDidCancel:(STPAddCardViewController * _Nonnull)_;
- (void)addCardViewController:(STPAddCardViewController * _Nonnull)_ didCreatePaymentMethod:(STPPaymentMethod * _Nonnull)paymentMethod completion:(void (^ _Nonnull)(NSError * _Nullable))completion;
@end
...
- (void)addPaymentPassViewController:(PKAddPaymentPassViewController * _Nonnull)_ generateRequestWithCertificateChain:(NSArray<NSData *> * _Nonnull)certificates nonce:(NSData * _Nonnull)nonce nonceSignature:(NSData * _Nonnull)nonceSignature completionHandler:(void (^ _Nonnull)(PKAddPaymentPassRequest * _Nonnull))handler;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// :nodoc:
- (void)safariViewController:(SFSafariViewController * _Nonnull)_ didCompleteInitialLoad:(BOOL)didLoadSuccessfully;
/// :nodoc:
- (void)safariViewController:(SFSafariViewController * _Nonnull)_ initialLoadDidRedirectToURL:(NSURL * _Nonnull)URL;
/// :nodoc:
