...
extension UIFont {
    class var largeThemeLabelFont: UIFont {
        return UIFont.init(name: "Charter-Roman", size: (0.039409 * UIViewController.screenSize.height))!
    }
...
extension UIImageView{
    class var LogoImageView: UIImageView{
        return UIImageView.init(image: UIImage.init(named: "charterRomanPurpleLogo-30"))
    }
}
extension Double{
