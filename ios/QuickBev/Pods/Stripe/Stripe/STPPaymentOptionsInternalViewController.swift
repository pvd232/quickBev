    ...
    UITableViewDelegate, STPAddCardViewControllerDelegate, STPBankSelectionViewControllerDelegate
{
    ...
    func tableView(_: UITableView, editingStyleForRowAt indexPath: IndexPath)
    ...
    func tableView(_ tableView: UITableView, didEndEditingRowAt _: IndexPath?) {
    ...
    required init(nibName _: String?, bundle _: Bundle?) {
        fatalError("init(nibName:bundle:) has not been implemented")
    }

    required init(theme _: STPTheme?) {
