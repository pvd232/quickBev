...
public class STPCoreViewController: UIViewController {
    ...
    @objc override public required init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?)
    {
    ...
    private var _theme = STPTheme.defaultTheme
    ...
    @objc func handleCancelTapped(_: Any?) {
