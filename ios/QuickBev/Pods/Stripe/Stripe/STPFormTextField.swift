...
@objc class STPFormTextField: STPValidatedTextField {
    ...
    /// :nodoc:
    @objc override public var attributedText: NSAttributedString? {
        get {
    ...
    /// :nodoc:
    @objc override public var accessibilityAttributedValue: NSAttributedString? {
        get {
    ...
    /// :nodoc:
    @objc override public var attributedPlaceholder: NSAttributedString? {
        get {
    ...
    /// :nodoc:
    @objc override public var keyCommands: [UIKeyCommand]? {
        return [
            UIKeyCommand(
    ...
    /// :nodoc:
    @objc override public weak var delegate: UITextFieldDelegate? {
        get {
            super.delegate
        }
        set {
