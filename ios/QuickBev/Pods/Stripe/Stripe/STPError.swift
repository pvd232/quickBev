...
@objc public extension NSError {
    ...
    static func stp_error(fromStripeResponse jsonDictionary: [AnyHashable: Any]?)
        -> NSError?
    {
        ...
        if let stripeErrorMessage = stripeErrorMessage {
            ...
            userInfo[NSLocalizedDescriptionKey] = stp_unexpectedErrorMessage()
        ...
        if errorType == "api_error" {
            ...
            let codeMap = [
                "incorrect_number": [
                    ...
                    "message": stp_cardErrorInvalidNumberUserMessage(),
                ],
                "invalid_number": [
                ...
                "invalid_expiry_month": [
                    ...
                    "message": stp_cardErrorInvalidExpMonthUserMessage(),
                ],
                "invalid_expiry_year": [
                    "code": STPCardErrorCode.invalidExpYear.rawValue,
                    "message": stp_cardErrorInvalidExpYearUserMessage(),
                ],
                "invalid_cvc": [
                    "code": STPCardErrorCode.invalidCVC.rawValue,
                    "message": stp_cardInvalidCVCUserMessage(),
                ],
                "expired_card": [
                    "code": STPCardErrorCode.expiredCard.rawValue,
                    "message": stp_cardErrorExpiredCardUserMessage(),
                ],
                "incorrect_cvc": [
                    "code": STPCardErrorCode.invalidCVC.rawValue,
                    "message": stp_cardInvalidCVCUserMessage(),
                ...
                "card_declined": [
                    ...
                    "message": stp_cardErrorDeclinedUserMessage(),
                ],
                "processing_error": [
                    "code": STPCardErrorCode.processingError.rawValue,
                    "message": stp_cardErrorProcessingErrorUserMessage(),
                ],
                "incorrect_zip": [
