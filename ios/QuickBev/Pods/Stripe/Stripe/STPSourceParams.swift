...
public extension STPSourceParams {
    ...
    /// - Returns: An STPSourceParams object populated with the provided values
    @objc
    class func alipayReusableParams(
    ...
    @objc internal func flowString() -> String? {
        return STPSource.string(from: flow)
    }

    @objc internal func usageString() -> String? {
    ...
    @objc
    func redirectDictionaryWithMerchantNameIfNecessary() -> [AnyHashable: Any] {
