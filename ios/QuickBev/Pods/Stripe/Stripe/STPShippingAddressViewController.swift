...
public class STPShippingAddressViewController: STPCoreTableViewController {
    ...
    @objc override func handleCancelTapped(_: Any?) {
    ...
    override public func tableView(
        _: UITableView, heightForHeaderInSection _: Int
    ) -> CGFloat {
    ...
    @objc func useBillingAddress(_: UIButton) {
    ...
    STPShippingMethodsViewControllerDelegate
{
    ...
    /// :nodoc:
    @objc
    public func tableView(_: UITableView, heightForFooterInSection _: Int)
        -> CGFloat
    {
        return 0.01
    }
    ...
    /// :nodoc:
    @objc
    public func tableView(_: UITableView, viewForHeaderInSection _: Int)
        -> UIView?
    {
    ...
    func shippingMethodsViewController(
        _: STPShippingMethodsViewController,
