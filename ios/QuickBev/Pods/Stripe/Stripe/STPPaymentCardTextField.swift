...
public class STPPaymentCardTextField: UIControl, UIKeyInput, STPFormTextFieldDelegate {
    ...
    @objc public dynamic var isValid: Bool {
    ...
    /// - seealso: UIResponder
    @objc @discardableResult override public func becomeFirstResponder() -> Bool {
    ...
    @objc internal lazy var brandImageView = UIImageView(
        image: STPPaymentCardTextField.brandImage(for: .unknown))
    @objc internal lazy var fieldsView = UIView()
    ...
    @objc private lazy var viewModel =
    ...
    @objc override public var backgroundColor: UIColor? {
        ...
        set {
            ...
            numberField.backgroundColor = newValue
        }
    }

    /// :nodoc:
    @objc override public var contentVerticalAlignment: UIControl.ContentVerticalAlignment {
        get {
    ...
    /// :nodoc:
    @objc override public var canResignFirstResponder: Bool {
