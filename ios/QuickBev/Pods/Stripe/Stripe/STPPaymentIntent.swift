...
public extension STPPaymentIntent {
    ...
    @objc var nextSourceAction: STPIntentAction? {
        return nextAction
    }
}
...
extension STPPaymentIntent {
    ...
    class func id(fromClientSecret clientSecret: String) -> String? {
...
extension STPPaymentIntentStatus {
    ...
    static func status(from string: String) -> STPPaymentIntentStatus {
