...
final class STPTelemetryClient: NSObject {
    @objc(sharedInstance) static var shared = STPTelemetryClient(sessionConfiguration: STPAPIClient.sharedUrlSessionConfiguration)
    ...
    private lazy var platform = [deviceModel, osVersion].joined(separator: " ")
