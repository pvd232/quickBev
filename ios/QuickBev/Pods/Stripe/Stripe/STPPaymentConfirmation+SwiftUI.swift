...
struct ConfirmPaymentPresenter<ParamsType, CompletionBlockType>: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, STPAuthenticationContext {
        ...
        private func presentConfirmationSheet() {
            if let params = parent.intentParams as? STPPaymentIntentParams,
               let completion = parent.onCompletion as? STPPaymentHandlerActionPaymentIntentCompletionBlock
            {
            ...
            } else if let params = parent.intentParams as? STPSetupIntentConfirmParams,
                      let completion = parent.onCompletion as? STPPaymentHandlerActionSetupIntentCompletionBlock
            {
        ...
        private func forciblyDismissConfirmationSheet() {
            authenticationPresentingViewController().dismiss(animated: true)
        }
    }
}
...
public extension View {
    ...
    func setupIntentConfirmationSheet(
