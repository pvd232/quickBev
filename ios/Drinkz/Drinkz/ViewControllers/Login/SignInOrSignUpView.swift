...
class SignInOrSignUpView: UIView {
    ...
    init(frame: CGRect, props: SignInAndSignUpProps){
        ...
        NSLayoutConstraint.activate([
            logoImageView.widthAnchor.constraint(equalTo: safeArea.widthAnchor, multiplier: 0.565217 ),
            logoImageView.heightAnchor.constraint(equalTo: safeArea.widthAnchor, multiplier: 0.565217),
