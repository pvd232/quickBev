...
class CheckoutCartTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        NSLayoutConstraint.activate([
            ...
            stackView.widthAnchor.constraint(equalTo: margins.widthAnchor, multiplier: 0.6),
            name.centerYAnchor.constraint(equalTo: margins.centerYAnchor),
            cost.centerYAnchor.constraint(equalTo: margins.centerYAnchor)
        ])
    }
