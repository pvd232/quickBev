...
const Dashboard = (props) => {
	...
	const pages = [
		<HomeSplash orderArray={props.orderArray} fixedHeightPaper={fixedHeightPaper} classes={classes} />,
		<Customers fixedHeightPaper={fixedHeightPaper} classes={classes} customers={props.customers} />,
	];
